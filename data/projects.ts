...
export const projects: Project[] = [
  ...
  {
    slug: "reporty",
    name: "Reporty (Project Iron Dome)",
    summary: "Workplace Harassment Risk Management Platform with Cryptographic Data Integrity",
    description:
      "한국 직장 내 괴롭힘 예방을 위한 엔터프라이즈 컴플라이언스 플랫폼입니다. 블록체인 영감의 Merkle Tree로 변조 방지 증거 체인을 구현하고, LLM 기반 PII 탐지로 GDPR/PIPA 준수를 보장하며, Vector DB로 지능형 판례 검색을 제공합니다.",
    intent: "HR 조사에서 가장 큰 신뢰 문제를 해결하고자 했습니다: 양측 모두 기록 조작 동기가 있을 때 증거 무결성을 어떻게 증명할 것인가? Merkle Tree 아키텍처는 모든 변조를 암호학적으로 탐지 가능하게 합니다.",
    category: "b2b-saas",
    stack: ["React", "FastAPI", "PostgreSQL", "Qdrant", "OpenAI GPT-4", "Merkle Tree"],
    techStackMap: {
      Frontend: ["React", "Vite", "Tailwind CSS"],
      Backend: ["FastAPI", "Python 3.11", "Pydantic v2"],
      Database: ["PostgreSQL (Primary)", "Qdrant (Vector Search)"],
      Security: ["Merkle Tree (데이터 무결성)", "SHA-256 Hash Chain", "Audit Log"],
      AI: ["GPT-4 (PII 탐지)", "LangChain", "Embedding Models"],
      Compliance: ["PIPA (개인정보보호법)", "GDPR-ready Architecture"],
    },
    highlights: [
      "Merkle Tree 구현 - 암호학적 증거 무결성 검증",
      "LLM 기반 PII 탐지 - 보고서 내 실수로 인한 데이터 노출 방지",
      "Vector DB 시맨틱 검색 - 10,000+ 한국 노동법 판례",
      "자동 PDF Defense Pack 생성 - 법적 절차용",
      "코드명 'Project Iron Dome' - 직원과 고용주 모두 보호 설계",
      "해시 검증 감사 추적 - 규제 컴플라이언스 감사용",
      "Twitter/X Merkle Root 앵커링 - 외부 검증",
    ],
    featured: true,
    metrics: {
      duration: "3개월",
      role: "System Architect & Lead Dev",
      impact: "Tamper-proof 증거 체인",
    },
  },
  {
    slug: "arbquant",
    name: "ArbQuant",
    summary: "Production-Grade Cryptocurrency Arbitrage System with Quantitative Risk Management",
    description:
      "기관급 리스크 관리 원칙을 적용한 엔터프라이즈급 KIMP 차익거래 플랫폼입니다. Human-in-the-loop 승인 워크플로우를 갖춘 Gray Box 아키텍처, Kelly Criterion 포지션 사이징, Almgren-Chriss 시장 영향 모델링, Out-of-Sample 검증이 포함된 Walk-Forward 백테스팅을 제공합니다.",
    intent: "개인 트레이딩 시스템도 기관급 리스크 관리를 달성할 수 있음을 입증하기 위해 설계했습니다. 수익률보다 자본 보전을 우선시하며, 다중 서킷 브레이커와 상관관계 리스크 모니터링을 갖추고 있습니다.",
    category: "automation",
    stack: ["Go", "Next.js", "TimescaleDB", "NATS JetStream", "Redis", "Fly.io", "Oracle Cloud"],
    techStackMap: {
      Core: ["Go 1.21", "Goroutines/Channels (동시성)"],
      Frontend: ["Next.js 14", "실시간 WebSocket 대시보드"],
      Database: ["TimescaleDB (시계열)", "Redis (신호 캐시)"],
      Messaging: ["NATS JetStream (Event Sourcing)"],
      Infra: ["Fly.io (Primary)", "Oracle Cloud (Failover)", "Multi-region"],
      DevOps: ["Conventional Commits", "P0/P1/P2 이슈 관리", "CVE 모니터링"],
    },
    highlights: [
      "Kelly Criterion 포지션 사이징 + 동적 변동성 조정",
      "Almgren-Chriss 시장 영향 모델로 최적 실행 타이밍 산출",
      "Z-Score 진입 신호 + 자산 쌍 간 상관관계 리스크 모니터링",
      "Walk-Forward 백테스트 프레임워크 (OOS 검증 포함)",
      "FX 리스크 헤징 레이어 (KRW/USD 노출 관리)",
      "40+ PRs merged (Conventional Commit 표준 준수)",
      "CVE 패칭 워크플로우 + 자동화된 보안 알림",
      "멀티 클라우드 배포 + 자동 페일오버 (Fly.io + Oracle Cloud)",
      "Telegram 모바일 콕핏 - 실시간 모니터링 및 수동 개입",
    ],
    featured: true,
    metrics: {
      duration: "2개월",
  ...
  },
  {
    ...
    techStackMap: {
      Core: ["Rust (Workspace Architecture)", "cfb (OLE/CFB 파싱)"],
  ...
  // ===== CTO-Focused Projects (GitHub Analysis) =====
  {
    slug: "ansim-golf",
    name: "Ansim Golf",
    summary: "Golf Course Automation Platform with Senior-Friendly UI Design",
    description:
      "골프장 운영의 End-to-end 자동화 플랫폼입니다. 자동 정산 시스템, 노쇼 자동 청구, 비기술 직원(시니어 운영자)도 복잡한 예약 워크플로우를 관리할 수 있는 대시보드를 제공합니다.",
    intent: "골프장 관리 시스템이 실패하는 이유는 기술적 한계가 아니라 운영자(종종 50-60대)가 복잡한 UI를 탐색할 수 없기 때문임을 인식했습니다. 기능 밀도보다 접근성을 우선시했습니다.",
    category: "b2b-saas",
    stack: ["Next.js", "TypeScript", "Cloudflare D1", "Cloudflare Workers"],
    techStackMap: {
      Frontend: ["Next.js 14", "React", "Tailwind CSS"],
      Backend: ["Cloudflare Workers (Edge)", "Cloudflare D1 (SQLite)"],
      Automation: ["Cron Triggers", "Webhook Integrations"],
      UX: ["Senior-Friendly UI Patterns", "Large Touch Targets", "High Contrast"],
    },
    highlights: [
      "시니어 친화적 UI - 큰 터치 타겟, 단순화된 워크플로우",
      "자동 정산 시스템 - 수작업 정산 80% 감소",
      "노쇼 자동 청구 - SMS 알림 통합",
      "Edge-first 아키텍처 - Cloudflare에서 50ms 이하 응답",
      "Zero-downtime 배포 - Cloudflare Workers",
    ],
    featured: true,
    metrics: {
      duration: "6주",
  ...
  },
  {
    ...
    category: "b2c-consumer",
    stack: ["React", "TypeScript", "Cloudflare Workers", "Toss SDK"],
    techStackMap: {
      Frontend: ["React", "TypeScript", "Toss Apps SDK"],
      Backend: ["Cloudflare Workers"],
      Operations: ["RUNBOOK Documentation", "DISASTER_RECOVERY Procedures"],
  ...
  },
  {
    slug: "sense-typing",
    name: "Sense Typing",
    summary: "PRD-Driven Typing Practice Platform with Authority-Based Design",
    description:
      "공식 PRD 기반 개발 프로세스로 구축된 타이핑 연습 플랫폼입니다. 모든 디자인 결정이 개인 취향이 아닌 연구와 사용자 테스트에 기반한 'Authority-driven 디자인 철학'을 시연합니다.",
    intent: "단순해 보이는 유틸리티도 엄격한 제품 개발 방법론의 혜택을 받을 수 있음을 보여줍니다. 모든 디자인 결정이 문서화되고 정당화되었습니다.",
    category: "b2c-consumer",
    stack: ["React", "TypeScript", "Tailwind CSS", "Vite"],
    techStackMap: {
      Frontend: ["React 18", "TypeScript", "Tailwind CSS 4"],
      Build: ["Vite", "Vitest"],
      Design: ["PRD-driven", "Authority-based Design"],
      Accessibility: ["WCAG 2.1 AA Compliance"],
    },
    highlights: [
      "PRD 기반 개발 - 공식 요구사항 문서화",
      "Authority-driven 디자인 - 연구/사용자 테스트 기반 결정",
      "Cmd+K 글로벌 검색 - 실시간 필터링",
