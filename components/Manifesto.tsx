    ...
    <section className="py-16 md:py-20 bg-white">
      <div className="system-grid">
        ...
        <div className="col-span-12 mb-8 md:mb-12">
          <span className="text-label text-[#00cc00] mb-2 block">Analysis</span>
          <h2 className="text-3xl md:text-4xl font-bold text-[#171a20] mb-3 tracking-tight">Target Sectors</h2>
          <p className="text-[#3e3e3e] max-w-2xl leading-[1.7] text-base md:text-lg">
            시장의 비효율은 곧 기회입니다. 복잡성이 높은 영역에 진입하여 구조적 문제를 해결합니다.
          </p>
        </div>
        ...
        <div className="col-span-12 flex flex-col">
          ...
          {[
            ...
            <div key={idx} className="group py-4 md:py-5 border-b border-[#f2f4f6] last:border-b-0 grid grid-cols-1 md:grid-cols-12 gap-2 md:gap-4 items-center hover:bg-[#fafafa] transition-colors rounded-lg px-4 -mx-4">
