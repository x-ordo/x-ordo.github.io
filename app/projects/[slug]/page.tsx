...
export default async function ProjectDetailPage({ params }: PageProps) {
  ...
  return (
    <div className="px-6 md:px-8 lg:px-12 pb-24 md:pb-36 lg:pb-48 pt-8 md:pt-12">
      <div className="mx-auto max-w-7xl flex flex-col gap-8 md:gap-12">

        {/* Back Button - Large, Prominent, Interactive */}
        <Link
          href="/projects"
          className="group inline-flex items-center gap-4 px-6 py-4
                     ...
                     transition-all duration-150 cursor-pointer select-none w-fit"
        >
          <svg
        ...
        <section className="flex flex-col gap-8 md:gap-10">
          ...
          <p className="text-xl md:text-2xl lg:text-3xl font-bold text-black/85 leading-[1.6] max-w-4xl">
            {project.summary}
          </p>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-5 md:gap-6">
              {project.metrics.duration && (
                <div className="group bg-white border-4 border-black p-6 md:p-8 shadow-[6px_6px_0_#000] hover:shadow-[8px_8px_0_#00ff00] hover:-translate-x-0.5 hover:-translate-y-0.5 transition-all cursor-default">
                  <div className="text-xs md:text-sm font-black text-black/40 uppercase tracking-widest mb-4">
                    Duration
                  </div>
              ...
              {project.metrics.impact && (
                <div className="group bg-[#00ff00] border-4 border-black p-6 md:p-8 shadow-[6px_6px_0_#000] hover:shadow-[8px_8px_0_#000] hover:-translate-x-0.5 hover:-translate-y-0.5 transition-all cursor-default">
                  <div className="text-xs md:text-sm font-black text-black/60 uppercase tracking-widest mb-4">
                    Impact
                  </div>
                  <div className="text-2xl md:text-3xl font-black text-black">
                    {project.metrics.impact}
          ...
          {project.metrics?.quantitative && project.metrics.quantitative.length > 0 && (
            <div className="bg-black border-4 border-black p-6 md:p-8 shadow-[8px_8px_0_#00ff00]">
          ...
          {project.intent && (
            <div className="bg-white border-4 border-black p-8 md:p-12 shadow-[8px_8px_0_#000] hover:shadow-[12px_12px_0_#00ff00] hover:-translate-x-1 hover:-translate-y-1 transition-all">
          ...
          <div className="max-w-4xl flex flex-col gap-6">
            <h3 className="text-sm md:text-base font-black text-black/40 uppercase tracking-[0.15em] flex items-center gap-3">
        ...
        {/* Content Grid */}
        <div className="grid gap-12 md:grid-cols-[1.6fr_1fr] lg:gap-16">
              ...
              {project.techStackMap ? (
                <div className="flex flex-col gap-8 md:gap-10">
                  {Object.entries(project.techStackMap).map(([category, items]) => (
                    <div key={category} className="flex flex-col gap-4 md:gap-5">
                      <h3 className="text-sm md:text-base font-black text-black/60 uppercase tracking-widest flex items-center gap-3">
        ...
        {/* Bottom Navigation */}
        <div className="pt-12 md:pt-16 border-t-4 border-black/10">
          <Link
            href="/projects"
